...
# ENGLISH WORDS
wordsEN = ["NEW YORK", "CALIFORNIA","TEXAS","MEXICO","LONDON","MANCHESTER","BRIGHTON",
           ...
           "APPLE","SAMSUNG","TABLET","BRUSH","WATER","PAPER",
           "FLAG","PYTHON","PYGAME","COSMOS", "PHYSICS", "CHEMISTRY", "BIOLOGY", "MATHEMATICS", "GEOGRAPHY",
           "WORKOUT","MARIE CURIE","BASKETBALL", "LOVE", "LAPTOP", "COMPUTER", "ELEPHANT", "TEACHER", "STUDENT",
           "ASTRONOMY","METEORITE","STAR","SOLAR SYSTEM","GALAXY","RANCH SAUCE","CHEDDAR SAUCE","BURGER",
           "BURGER KING","COUNTRY","DRAGON", "DANCE", "ART", "PAINTING", "DRAWING", "SKETCH",
           "LIZARD", "DUMBLEDORE","GANDALF","MAGICIAN","GOOGLE","MICROSOFT","ARTIFICAL INTELLIGENCE",
           "MACHINE LEARNING","HIGHSCHOOL","UNIVERSITY","OXFORD UNIVERSITY","CAMBRIDGE UNIVERSITY","COMPUTER SCIENCE",
           "WINDOWS","LINUX","HEADPHONES","WATER","DRINK" , "lOVE",
           "ONE PIECE","TERMINATOR","AVENGERS","APARTMENT",
           "GABE NEWELL","PHOTOSHOP","VISUAL STUDIO","HANGMAN","XBOX ONE","DOG", "CAT",
           "DEATH NOTE","NETFLIX AND CHILL","NETFLIX","ANIMATION","CARBON","DIAMOND","MONA LISA",
          "JEWISH","MUSLIM","MAGIC","SPRAY","PAINT","GEORGE","JOHN","ADAM","JENNA",
